            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center left-0 top-0 bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                    <div className="text-white pl-24  space-y-7 w-1/2">
                        ...
                        <div className="mt-5">
                            <button className="btn  bg-red-600 border-none text-white hover:bg-white hover:text-black mr-5">Discover More</button>
                            <button className="btn btn-outline  border-white text-white hover:bg-white">Latest Project</button>
